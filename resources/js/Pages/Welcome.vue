    ...
    <div class="max-w-6xl mx-auto -mt-24 sm:px-6 lg:px-8">
      <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
        <svg
          ...
          class="w-auto h-16 text-laravel-500 sm:h-20">
      ...
      <div class="mt-12 overflow-hidden bg-white shadow-lg dark:bg-gray-800 sm:rounded-lg">
        <div class="grid grid-cols-1 md:grid-cols-2">
          <div class="p-6">
            <div class="flex items-center">
              <IconOutlineBookOpen class="w-auto h-8 text-gray-500" />
          ...
          <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
            <div class="flex items-center">
              <IconOutlineCamera class="w-auto h-8 text-gray-500" />
              <div class="ml-4 text-lg font-semibold leading-7">
          ...
          <div class="p-6 border-t border-gray-200 dark:border-gray-700">
            <div class="flex items-center">
              <IconOutlineNewspaper class="w-auto h-8 text-gray-500" />
              <div class="ml-4 text-lg font-semibold leading-7">
          ...
          <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
            <div class="flex items-center">
              <IconOutlineGlobeAlt class="w-auto h-8 text-gray-500" />
            ...
            <div class="ml-12">
              <div class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <a href="https://laravel.com/docs/telescope" class="underline">Telescope</a>{{ __(', and more.') }}
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="flex justify-center mt-12 sm:items-center sm:justify-between">
        <div class="text-sm text-center text-gray-500 sm:text-left">
          <div class="flex items-center">
            <IconOutlineShoppingCart class="w-auto h-5 -mt-px text-gray-400" />
            <a href="https://laravel.bigcartel.com" class="ml-1 underline"> Shop </a>

            <IconOutlineHeart class="w-auto h-5 ml-4 -mt-px text-gray-400" />
